...
/* 下拉框 */
var select_team = {
    "ALL": ["ALL"], "SNH48": ["ALL", "TEAM SII", "TEAM NII", "TEAM HII", "TEAM X", "预备生", "TEAM FT"],
    "GNZ48": ["ALL", "TEAM G", "TEAM NIII", "TEAM Z", "预备生"], "BEJ48": ["ALL", "TEAM B", "TEAM E", "TEAM J", "预备生"],
    "CKG48": ["ALL", "TEAM C", "TEAM K", "预备生"], "SHY48": ["ALL", "TEAM SIII", "TEAM HIII", "预备生"],
    "IDFT": ["ALL"], "海外练习生": ["ALL"]
};
